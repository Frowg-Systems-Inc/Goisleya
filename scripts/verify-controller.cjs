...
const requiredGrowthPlannerContracts = [
  ...
  ['saved server multiplier', 'ServerMultiplierIndex = _growthServerMultiplierIndex'],
  ['saved pause state', 'Paused = _growthPaused'],
...
const requiredNestPlannerContracts = [
  ...
  ['persistent planner snapshot', 'Nest = new PlannerNestState'],
...
const requiredMutationPlannerContracts = [
  ...
  ['persistent loadout snapshot', 'Loadout = _mutationLoadout.Select'],
  ...
  ['persistent build focus snapshot', 'BuildFocusIndex = _mutationBuildFocusIndex'],
...
const requiredMutationUnlockContracts = [
  ...
  ['persistent progress snapshot', 'UnlockProgress = _mutationUnlockProgress.Select'],
